...
//				curl_setopt($ch, CURLOPT_TIMEOUT, 5);// allow it to respond in 5 seconds
//				curl_exec($ch);
//				$contentType = curl_getinfo($ch, CURLINFO_CONTENT_TYPE);
//				if(stripos($contentType, 'xml') === false) {// skip it if it's not valid xml
//					continue;
//				}
